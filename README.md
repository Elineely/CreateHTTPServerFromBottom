...
cuteWebserv는 C++로 작성된 HTTP 서버입니다. 이 서버는 NGINX와 같은 웹 서버처럼 동작하며, 
...
HTTP/1.1 을 기준으로 만들었으며, RFC 7230~7235 까지의 메서드 및 기타 표준 사항등을 엄격히 준수합니다. 단 메서드는 (GET /POST / PUT / DELETE / HEAD) 만 구현했습니다.
