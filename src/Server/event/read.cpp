...
void Server::clientReadEvent(struct kevent *current_event)
{
  ...
  current_udata->m_request->body.clear();
  Parser new_parser(*current_udata->m_request);
                                ...
                                struct Response &response)
{
  ...
  t_event_udata *udata = new t_event_udata(PIPE, current_udata->m_server, current_udata->m_request, current_udata->m_response);
  t_event_udata *udata2 = new t_event_udata(PROCESS, current_udata->m_server, current_udata->m_request, current_udata->m_response);
  ...
  {
    t_event_udata *udata1 = new t_event_udata(PIPE, current_udata->m_server, current_udata->m_request, current_udata->m_response);
                                   ...
                                   struct Response &response)
{
  ...
  udata = new t_event_udata(CLIENT, current_udata->m_server, current_udata->m_request, current_udata->m_response);
